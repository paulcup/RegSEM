!=====================================================
SUBROUTINE MERGE_MODEL_FILES(NPROC,BASE_NAME)
!=====================================================
!
IMPLICIT NONE
!
INTEGER :: IPROC,NPROC,N
INTEGER :: I,J,K,L
...
!==========================
!
WRITE(FILENAME,"(A,I3.3)")TRIM(BASE_NAME),0
...
IF(EXISTS)THEN
   ...
   !
   DO IPROC = 0,NPROC-1
      WRITE(FILENAME,"(A,I3.3)")TRIM(BASE_NAME),IPROC
   ...
   z = Z/1000.D0
   !
   WRITE(FILENAME,'(A,A)')TRIM(BASE_NAME),'.vts' 
...
!
!==================================
END SUBROUTINE MERGE_MODEL_FILES
!==================================
