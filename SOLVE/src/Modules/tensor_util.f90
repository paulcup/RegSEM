...
doubleprecision, parameter :: s2=1.4142135623730950488
doubleprecision, parameter :: os2=0.70710678118654
...
doubleprecision, dimension(1:6,1:6), intent(inout) :: CIJ
doubleprecision, intent(in) :: theta,phi

integer :: i,j,k,l,a,b,c,d
doubleprecision :: ct,st,cp,sp
doubleprecision, dimension(3,3) :: CCS
doubleprecision, dimension(3,3,3,3) :: cijkl,T
...
doubleprecision, dimension(1:6,1:6), intent(inout) :: CIJ
doubleprecision, dimension(1:3,1:3), intent(in) :: rot
...
doubleprecision, dimension(1:6,1:6), intent(out) :: CIJ
doubleprecision, dimension(1:3,1:3,1:3,1:3), intent(in) :: cijkl
...
doubleprecision, dimension(1:6,1:6), intent(in) :: CIJ
doubleprecision, dimension(1:3,1:3,1:3,1:3), intent(out) :: cijkl
...
! ###############################################
doubleprecision function lambda_from_Cij (C)

doubleprecision, dimension(1:6,1:6), intent(IN) :: C
...
! ###############################################
doubleprecision function mu_from_Cij (C)
